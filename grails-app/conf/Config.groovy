...
grails.resources.adhoc.patterns = ['/egret/*', '/images/*', '/css/*', '/js/*', '/plugins/*', '/fonts/*', '/vendor/*']
grails.resources.adhoc.includes = ['/egret/**', '/images/**', '/css/**', '/js/**', '/plugins/**', '/bootstrap/**', '/fonts/**', '/vendor/**']
