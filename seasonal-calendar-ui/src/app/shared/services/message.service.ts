...
export class MessageService {
  ...
  add(data: {
    text: string, timeout?: number, background?: string, colour?: string, customClass?: any,
    action?: { text: string, onClick?: Function, colour?: string }, onAdd?: Function, onRemove?: Function
  }) {
